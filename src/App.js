    ...
    >
      ...
      <Container component="main" sx={{ mt: 8, mb: 2, flex: 1 }}>
            ...
            <Grid item key={card} xs={12} sm={6} md={4}>
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Typography>
                    This card demonstrates MUI's Card component. It's great for displaying content
        ...
        <Box sx={{ mt: 4, display: 'flex', justifyContent: 'center', gap: 2 }}>
          ...
          <Chip avatar={<Avatar>JS</Avatar>} label="JavaScript" variant="outlined" />
        </Box>
      </Container>
      ...
      >
        <Container maxWidth="lg">
          <Typography variant="body1">Enhanced MUI React Page Footer</Typography>
      ...
      <Dialog open={dialogOpen} onClose={handleDialogClose}>
        ...
        <DialogContent>
          <DialogContentText>Fill out this form to get in touch with us.</DialogContentText>
          <TextField
            autoFocus
            margin="dense"
            id="name"
